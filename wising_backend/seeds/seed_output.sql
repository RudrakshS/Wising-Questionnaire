...
VALUES (
  ...
  'us_residency_detail',
  'REQUIRED',
  'Are you an exempt individual for SPT purposes?',
  'enum',
...
VALUES (
  ...
  'us_residency_detail',
  'CONDITIONAL',
  'Do you claim a closer connection to a foreign country (Form 8840)?',
  'boolean',
  NULL,
...
VALUES (
  ...
  'us_residency_detail',
  'OPTIONAL',
  'Are you making a first-year choice election (§7701(b)(4))?',
  'boolean',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'us_residency_detail',
  'OPTIONAL',
  'Is your NRA spouse making a §6013(g) joint-filing election?',
  'boolean',
  NULL,
  NULL,
  NULL,
