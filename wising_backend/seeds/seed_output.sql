...
VALUES (
  ...
  'jurisdiction_router',
  'CONDITIONAL',
  'Are you personally liable to pay income tax in any other country this year?',
  'boolean',
  NULL,
...
VALUES (
  ...
  'dtaa',
  'CONDITIONAL',
  'Which country is your current tax home (ISO code, e.g. US)?',
  'enum',
...
VALUES (
  ...
  'dtaa',
  'OPTIONAL',
  'Treaty rate elections (per income stream)',
  'array',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'compliance_docs',
  'OPTIONAL',
  'Do you have a Section 197 lower TDS certificate?',
  'boolean',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'compliance_docs',
  'CONDITIONAL',
  'Section 197 certificate rate (e.g. 0.05 for 5%)',
  'string',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'compliance_docs',
  'CONDITIONAL',
  'Section 197 certificate validity start date',
  'date',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'compliance_docs',
  'CONDITIONAL',
  'Section 197 certificate validity end date',
  'date',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'compliance_docs',
  'CONDITIONAL',
  'Income types covered by Section 197 certificate',
  'string',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'bank_accounts',
  'CONDITIONAL',
  'CRITICAL: even 1 day as ROR = full year NRE interest taxable (no mid-year split).',
  'enum',
  '["YYYY-MM-DD"]'::jsonb,
...
VALUES (
  ...
  'property',
  'CONDITIONAL',
  'agricultural_rural → exempt (s.10(37)). Only "residential" qualifies for s.54.',
  'enum',
...
VALUES (
  ...
  'profile',
  'REQUIRED',
  'Drives: 65+ additional standard deduction, OBBBA $6,000 senior deduction',
  'date',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'profile',
  'REQUIRED',
  'Drives every bracket, deduction cap, and phase-out in the schema.',
  'enum',
...
VALUES (
  ...
  'profile',
  'REQUIRED',
  '"none" → engine surfaces ITIN application requirement (Form W-7) before',
  'enum',
  '["ssn", "itin", "none"]'::jsonb,
  NULL,
  NULL,
...
VALUES (
  ...
  'profile',
  'CONDITIONAL',
  'Drives §6013(g)/(h) NRA-spouse election eligibility and CTC qualifying-child',
  'boolean',
  NULL,
...
VALUES (
  ...
  'us_residency_detail',
  'REQUIRED',
  'If true → final_us_residency_status = "US_CITIZEN"; SPT not evaluated;',
  'boolean',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'us_residency_detail',
  'REQUIRED',
  'Unsurrendered Green Card (no Form I-407) → "RESIDENT_ALIEN" regardless of days.',
  'boolean',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'us_residency_detail',
  'CONDITIONAL',
  'Drives: residency start date (first day physically present in US after grant),',
  'date',
  NULL,
...
VALUES (
  ...
  'us_residency_detail',
  'CONDITIONAL',
  'Drives the §877A expatriation tax cascade and Long-Term Resident determination.',
  'enum',
  '["YYYY-MM-DD"]'::jsonb,
...
VALUES (
  ...
  'us_residency_detail',
  'REQUIRED',
  'Pre-filled from Layer 0 us_days. Days physically present in CY 2026.',
  'integer',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'us_residency_detail',
  'REQUIRED',
  'Days physically present in CY 2025. Counted at 1/3 weight for SPT.',
  'integer',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'us_residency_detail',
  'REQUIRED',
  'Days physically present in CY 2024. Counted at 1/6 weight for SPT.',
  'integer',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'us_residency_detail',
  'REQUIRED',
  'Days as an exempt individual do NOT count toward SPT.',
  'enum',
...
VALUES (
  ...
  'us_residency_detail',
  'CONDITIONAL',
  'Triggers Form 8840 (Closer Connection Exception). Requires tax home and',
  'boolean',
  NULL,
...
VALUES (
  ...
  'state_residency',
  'REQUIRED',
  'true → part-year resident return required in BOTH states.',
  'boolean',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'state_residency',
  'CONDITIONAL',
  'Drives part-year apportionment.',
  'integer',
  NULL,
  '{"field": "layer1_us.state_residency.moved_states_this_year", "op": "eq", "value": true}'::jsonb,
  NULL,
...
VALUES (
  ...
  'state_residency',
  'CONDITIONAL',
  'CA aggressively pursues departing residents under the FTB "safe harbor"',
  'boolean',
  NULL,
...
VALUES (
  ...
  'state_residency',
  'CONDITIONAL',
  '546-day employment-abroad safe harbor (CA R&TC §17014(d)).',
  'boolean',
  NULL,
...
VALUES (
  ...
  'state_residency',
  'CONDITIONAL',
  'Strong domicile-retention indicator; FTB will likely contest non-residency.',
  'boolean',
  NULL,
  '{"field": "layer1_us.state_residency.ca_planning_departure", "op": "eq", "value": true}'::jsonb,
  NULL,
...
VALUES (
  ...
  'state_residency',
  'CONDITIONAL',
  'NY statutory residency: domicile elsewhere + permanent place of abode in NY',
  'boolean',
  NULL,
...
VALUES (
  ...
  'income_us_source',
  'OPTIONAL',
  '2026 phase-out: $201,775 single / $403,500 MFJ; SSTBs face full phase-out.',
  'boolean',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'foreign_earned_income',
  'CONDITIONAL',
  'Physical Presence: 330 full days in any 12-month period.',
  'enum',
...
VALUES (
  ...
  'foreign_entities',
  'REQUIRED',
  '≥10% ownership (vote or value) of a foreign corporation triggers Form 5471.',
  'boolean',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'foreign_entities',
  'REQUIRED',
  '≥10% interest in a foreign partnership triggers Form 8865.',
  'boolean',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'REQUIRED',
  'Form 3520 trigger: aggregate gifts from a foreign individual > $100,000',
  'boolean',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'foreign_gifts_and_trusts',
  'REQUIRED',
  'Is Us Beneficiary Of Foreign Trust',
  'boolean',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'foreign_gifts_and_trusts',
  'OPTIONAL',
  'expatriates — indefinitely after expatriation. Engine surfaces alert.',
  'boolean',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'OPTIONAL',
  'Engine auto-selects whichever is larger if "auto".',
  'enum',
...
VALUES (
  ...
  'ftc_inputs',
  'OPTIONAL',
  'reported on 1099-DIV/INT. Skip Form 1116 entirely.',
  'boolean',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'nra_specific',
  'CONDITIONAL',
  'Form W7 Itin Application Filed',
  'boolean',
  NULL,
  NULL,
  NULL,
...
VALUES (
  ...
  'nra_specific',
  'CONDITIONAL',
  'Engine surfaces FDAP withholding rules; this user does NOT file 1040,',
  'boolean',
  NULL,
  NULL,
  NULL,
